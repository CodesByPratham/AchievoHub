        ...
        try (Connection conn = DriverManager.getConnection(dbURL, dbUser, dbPassword); Statement stmt = conn.createStatement()) {
            ...
            if (isTableEmpty(conn, "USERS")) {
                stmt.executeUpdate("""
                    ...
                    VALUES (USERS_SEQ.NEXTVAL, 'kritikal', 'Kritika', 'Lohani', '9876543211', 'kritika@example.com', TO_DATE('1998-07-22', 'YYYY-MM-DD'), 'female', 'Sunshine Tower, Mumbai', 6, 3, '400001', 'securepass2', 'assets/uploads/profiles/kritika.jpg')
                """);
                
                stmt.executeUpdate("""
                    INSERT INTO USERS (ID, USERNAME, FNAME, LNAME, CONTACT, EMAIL, DOB, GENDER, ADDRESS, CITY, STATE, PINCODE, PASSWORD, PICTURE)
                    VALUES (USERS_SEQ.NEXTVAL, 'prathamr', 'Pratham', 'Rathod', '9876543210', 'pratham@example.com', TO_DATE('2000-05-12', 'YYYY-MM-DD'), 'male', '101 Residency, Ahmedabad', 2, 2, '380001', 'securepass1', 'assets/uploads/profiles/pratham.jpg')
                """);

                stmt.executeUpdate("""
                    INSERT INTO USERS (ID, USERNAME, FNAME, LNAME, CONTACT, EMAIL, DOB, GENDER, ADDRESS, CITY, STATE, PINCODE, PASSWORD, PICTURE)
                    VALUES (USERS_SEQ.NEXTVAL, 'devpatel', 'Dev', 'Patel', '9876543212', 'dev@example.com', TO_DATE('1996-12-05', 'YYYY-MM-DD'), 'male', 'Green Street, Surat', 3, 2, '395003', 'securepass3', 'assets/uploads/profiles/dev.jpg')
                """);
            }
