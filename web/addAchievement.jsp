<%-- 
    Document   : addAchievement
    Created on : 28-Nov-2024, 8:38:28 PM
    Author     : PRATHAM
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page errorPage="errorPage.jsp"%>
<%@page import="java.util.*, operations.Achievement, operations.User" %>
<%@page session="true" %>
<%
    ...
    request.setAttribute("pageTitle", "Add Achievement");
%>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <form action="Controller" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <label for="input-file" id="drop-area">
                                ...
                                <div id="add-image-view" class="add-image-view" >
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label>Title:</label>
                                <input type="text" name="title" class="form-control" placeholder="Enter Achievement Title" required />
                            </div>
                            <div class="form-group col-md-4">
                                <label>Organization's Name:</label>
                                <input type="text" name="organization" class="form-control" placeholder="Enter Organization's Name" required />
                            </div>
                            <div class="form-group col-md-4">
                                <label>Organization's Website:</label>
                                <input type="url" name="orgUrl" class="form-control" placeholder="Enter Organization's Website" required />
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Duration:</label>
                                <input type="" id="litepicker" name="duration" placeholder="Enter Duration" class="form-control" required />
                            </div> 
                            <div class="form-group col-md-6">
                                <label>Date Achieved:</label>
                                <input type="date" name="dateAchieved" class="form-control" required />
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-block" name="submit" value="addAchievement">Add Achievement</button>
                        </div>
                    </form>
                </div>
            </div>
        </div>
        <script src="resources/js/addAchievement.js"></script>
    </body>
</html>
