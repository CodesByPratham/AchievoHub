                        ...
                        <div class="row">
                            <div class="form-group col-md-3 flex">
                                ...
                                <div class="row justify-content-center">
                                    <img id="imgPhoto" class="img-fluid profile-img" src="<%=user.getPicture()%>" />
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label>Email:</label>
                                        <input type="email" name="email" value="<%=user.getEmail()%>" placeholder="Enter Email" class="form-control" required />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Contact:</label>
